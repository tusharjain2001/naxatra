...
function FilterDropdown({ label, options, value, onChange }) {
  ...
  return (
    <div className="relative">
      <button
        onClick={() => setOpen((o) => !o)}
        className="flex items-center gap-2 font-metro bg-white border border-[#9d9d9d] rounded-[4px] max-[768px]:!min-w-0 max-[768px]:!px-[8px] max-[768px]:!py-[5px] max-[768px]:!text-[8px]"
        style={{
    ...
    <section className="w-full bg-white">
      ...
      >
        <h2
          ...
          style={{ fontSize: '20px', lineHeight: '1.15', fontWeight: 400, marginBottom: '4px' }}
        >
        ...
        <div className="flex items-center" style={{ gap: '4px', marginBottom: '8px' }}>
          <div
            className="flex items-center gap-2 flex-1 border border-[#d9d9d9] rounded-[2px]"
            style={{
          ...
          >
            <svg width="10" height="10" viewBox="0 0 24 24" fill="none" style={{ flexShrink: 0 }}>
              ...
              <path d="M16.5 16.5L21 21" stroke="#b3b3b3" strokeWidth="2" strokeLinecap="round" />
            </svg>
            <input
              type="text"
              ...
              style={{ fontSize: '8px', color: '#515151', minWidth: 0 }}
            />
          </div>

          <button
            className="inline-flex items-center justify-center bg-[#1863da] text-white font-nexa rounded-[2px]"
            style={{
              fontSize: '10px',
              paddingInline: '18px',
              paddingBlock: '6px',
        ...
        <div className="flex justify-start" style={{ gap: '6px', marginBottom: '18px' }}>
                ...
                <div className="flex items-start justify-between" style={{ gap: '12px' }}>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <h3
                      ...
                      style={{ fontSize: '12px', fontWeight: 400, lineHeight: '1.2', margin: 0 }}
                    >
                      {job.title}
                    </h3>
                  </div>

                  <div className="flex flex-col items-end" style={{ gap: '5px', minWidth: '94px' }}>
                    <span
                      className="flex items-center gap-1 font-metro"
                      style={{ fontSize: '7px', color: '#111111', lineHeight: 1.3, textAlign: 'right' }}
                    >
                      <svg width="8" height="8" viewBox="0 0 24 24" fill="none" style={{ flexShrink: 0 }}>
                    ...
                    <span
                      className="flex items-center gap-1 font-metro"
                      style={{ fontSize: '7px', color: '#111111', lineHeight: 1.3 }}
                    >
                      <svg width="8" height="8" viewBox="0 0 24 24" fill="none" style={{ flexShrink: 0 }}>
